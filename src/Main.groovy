...
generatorsConfigs.each { generatorsConfig ->
    ...
    generatorsConfig.each { it ->
        ...
        logs.append  "T = " + generator.T + ", M = " + generator.M + "\n"
        logs.append  generator.numbers
        logs.append  "\n"
        logs.append  mapToString(countElements(generator.numbers))
        logs.append  "\n\n"
    ...
    for ( int i = 2; i <= maxM; i++){
        ...
        logs.append  "Multiplexed with M = " + gm.M + " and T = " + gm.T + ":\n"
        logs.append  gm.line
        logs.append  "\n"
        logs.append  mapToString(countElements(gm.line))
        logs.append  "\n\n"
    }

    logs.append  "===============Experiment end=============================\n"
}
